                    ...
                    <div class="col-2 text-center me-auto">
                      <a class="btn btn-link px-3" href="javascript:;">
                        <i class="fa fa-google text-white text-lg"></i>
                            ...
                            <div class="card-body">
                                <form role="form" class="text-start" action="{{ url('login') }}" method="post" autocomplete="off">
                                  @csrf
                                    <div
                                        class="input-group input-group-outline my-3 {{ old('email') != null ? 'focused is-focused' : '' }}">
                                    ...
                                    @enderror
                                    <div
                                        class="input-group input-group-outline mb-3 {{ old('password') != null ? 'focused is-focused' : '' }}">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                {{ env('APP_NAME') }} - Swadand
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.swadand.me" class="nav-link text-white"
                                        target="_blank">Swadand</a>
                                </li>
                                <li class="nav-item">
